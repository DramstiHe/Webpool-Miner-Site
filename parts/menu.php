    ...
    <div class="collapse navbar-collapse" id="navbartop">
        ...
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="navbar-brand" href="/"><img class="logo" height="40" src="https://webminepool.com/img/logo.png">WebMineSOLO</a>
          </li>
        </ul>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdown01">
                    <a target="_blank" class="dropdown-item" href="<?= $config->miner_url ?>">Miner</a>
                  </div>
                </li>
